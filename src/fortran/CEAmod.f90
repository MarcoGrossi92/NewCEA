...
!***********************************************************************
  ...
  INTEGER :: read_d
  INTEGER :: NLinesSet, NLine, makeio

  CHARACTER(132) :: InpLines(NLINES)
  ...
  REAL(8), PARAMETER :: Atmwt(101) = [1.00794D0,2.014102D0,4.002602D0,6.941D0, &
       ...
       91.224D0,92.90638D0,95.94D0,97.9072D0,101.07D0,102.9055D0,106.42D0, &
  ...
  REAL(8), PARAMETER :: Valnce(101) = [1.,1.,0.,1.,2.,3.,4.,0., - 2., - 1.,0.,1.,2.,3.,4.,5., &
  ...
  LOGICAL :: Convg, Debug(NCOL), Detdbg, Detn, Eql, Gonly
  LOGICAL :: Hp, Ions, Massf, Moles, Newr, Pderiv, Shock, Short_bn, Siunit, Sp, Tp, Trnspt, Vol

  REAL(8) :: Eqrat, Hsub0, Oxfl, Pp, R, Size_bn, S0, Tln, Tm, Trace, Tt, Viscns, Vv
  ...
  CHARACTER(2), PARAMETER :: Symbol(101) = ['H ','D ','HE','LI','BE','B ','C ','N ','O ','F ', &
  ...
  CHARACTER(10) :: Thdate
  CHARACTER(15) :: Case_bn, Energy(MAXR)
  CHARACTER(15) :: Omit(0:MAXNGC), Pltvar(20), Prod(0:MAXNGC), Rname(MAXR)
  CHARACTER(200) :: Pfile

  REAL(8) :: Cpr(NCOL), Dlvpt(NCOL), Dlvtp(NCOL), Gammas(NCOL), Hsum(NCOL), Ppp(NCOL), Ssum(NCOL), Totn(NCOL), Ttt(NCOL), Vlm(NCOL), Wm(NCOL)
  ...
  REAL(8) :: Aeat(NCOL), App(NCOL), Pcp(2*NCOL), Sonvel(NCOL), Spim(NCOL), Subar(13), Supar(NCOL), Vaci(NCOL), Vmoc(NCOL)
