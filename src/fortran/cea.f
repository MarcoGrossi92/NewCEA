...
C////////////////////////////////////////////////////////////////////////
      subroutine cea( prefix, myfile, make_out_files, read_data )
      use CEA_module
      IMPLICIT NONE
...
C SET ASSIGNED T
          DO It = 1,Nt
            ...
            ELSE
              IF ( HP .and.(makeio.ne.0)) WRITE (8,99003)
              IF ( TP .and.(makeio.ne.0)) WRITE (8,99004)
              IF ( Sp .and.(makeio.ne.0)) WRITE (8,99005)
            ENDIF
            CALL OUT1
            if(makeio.ne.0)WRITE (8,99009)
            CALL OUT2
